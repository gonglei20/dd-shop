...
<div id="content" class="white">
    <h1><img src="${pageContext.request.contextPath}/images/logo/logo1.png" alt="">微信4S后台管理 </h1>
    <div class="bloc left">
        <div class="title"> 快捷入口</div>
        <div class="content dashboard">
            <div class="center" style="display: block; width: auto;">
                <a class="shortcut"> <img src="" alt="" width="48" height="48"> 品牌车型 </a>
                <a class="shortcut"> <img src="" alt="" width="48" height="48"> 客户管理 </a>
                <div class="cb"></div>
            </div>
        </div>
    </div>
