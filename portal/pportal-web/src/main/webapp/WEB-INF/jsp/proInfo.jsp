    ...
    <script type="text/javascript">
        ...
        function addToCart(productId,count,fashId) {
            $.post('/cart/add_orderItem.jspx', {
                ...
                if(data.status==1) {
                    location.href='/cart/shopping_cart.jspx?backUrl=http://demo3.jeecms.com/woman/35.htm';
                } else if(data.status==0) {
                    location.href='/login.jspx?returnUrl=http://demo3.jeecms.com/woman/35.htm';
                } else {
                    alert(data.error);
                }
            },'json');
            ...
            <div class="Detail-mm fl">
                ...
                <div class="Detail-spec p10">
                    ...
                    <dl class="buy cf">
                        ...
                        <dd>
                            <span>
	                           <input type="button" class="cart" value="加入购物车" onclick="javascript:addToCart(35,$('#product_amount').val(),$('#current_merchantId').val());"/>
	                        </span>
                        </dd>
                    </dl>
